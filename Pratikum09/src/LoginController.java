...
public class LoginController {
	...
	public void setTextUsername(JTextField textUsername) {
		...
		private void initialize() {
			...
			labelIcon.setIcon(new ImageIcon("D:\\Praktikum-Maven-Agus\\PBO-MAVEN-09\\PBO-MAVEN-09\\logo-ibik-web.png"));
			...
			JLabel labelCopyright = new JLabel("(c) 2021 Muhamad Agus Setiawan");
